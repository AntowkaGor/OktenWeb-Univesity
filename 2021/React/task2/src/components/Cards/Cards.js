import styles from "../../../../start-react/src/components/MainCard/Card.module.css";
...
export function Card() {
    const [card, delateCard] = useState(true)
    const delateOneCard = () =>{
        delateCard( card.styles.visible = false)
    }
    return (
        <article className={styles.card}>
            ...
            <button onClick={delateOneCard}>Delate</button>
