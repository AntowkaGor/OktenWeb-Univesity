...
// let serName = prompt('you Ser name');
// let lastName = prompt('you last name');
// console.log(name + serName + lastName);
// alert(name + serName + lastName);
// // - Взять переменные из задания 4 и сконкатенировать их в одной переменной person.
// let name = prompt('you Name');
// let serName = prompt('you Ser name');
// let lastName = prompt('you last name');
// let person = name + serName + lastName;
// console.log(person);
...
// console.log(Math.round(parseFloat(prompt('num1') + prompt('num2'))));
